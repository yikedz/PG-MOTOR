	...
	; Compiler options:
	;
	; -opg.cof -mpg.map --summary=default --output=default main.p1 \
	; modbus_rtu.p1 mbcrc.p1 --chip=18F25K22 -P --runtime=default \
...
clear_1:
	...
	bnz	clear_1
	lfsr	0,96
	movlw	51	; loop counter
clear_2:
	clrf	postinc0,c	; clear, increment FSR0
	decf	wreg,c	; decrement loop counter
	bnz	clear_2
	lfsr	0,256
	movlw	200	; loop counter
clear_3:
	clrf	postinc0,c	; clear, increment FSR0
	decf	wreg,c	; decrement loop counter
	bnz	clear_3
